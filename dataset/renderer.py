...
COLOR_PAIRS = [
    ...
    ((245, 245, 220), (160, 120, 80)),      # Warm beige / walnut
    ((238, 238, 210), (130, 130, 90)),      # Olive classic
    ((232, 235, 239), (90, 110, 140)),      # Steel blue
    ((250, 240, 230), (180, 110, 80)),      # Soft peach / terracotta
    ((240, 240, 240), (70, 90, 110)),       # Cool slate
    ((225, 235, 225), (85, 120, 100)),      # Sage green
    ((245, 230, 255), (130, 90, 160)),      # Lavender / plum
    ((255, 248, 220), (170, 140, 60)),      # Sand / bronze
    ((230, 240, 255), (100, 130, 170)),     # Mist blue
    ((245, 228, 215), (140, 90, 70)),       # Classic wood
]
